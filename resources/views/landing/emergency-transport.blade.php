                    ...
                    <div class="service-details__sidebar">
                        <div class="service-details__sidebar-single">
                            ...
                            <div class="service-details__sidebar-single-service">
                                <ul class="clearfix">
                                    ...
                                    <li><a href="#">Fast Personal Delivery <span
                                                class="icon-right-arrow21"></span></a></li>
                                    ...
                                    <li><a class="active" href="/emergency-transport">Emergency Transport <span
                                                class="icon-right-arrow21"></span></a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="service-details__sidebar-contact text-center">
                            <div class="service-details__sidebar-contact-img">
                                <div class="inner">
                                    <img src="{{ asset('assets/images/resources/service-details-sidebar-img.png') }}" alt="">
                                </div>
                            </div>
                            ...
                            <div class="service-details__sidebar-contact-content">
                                ...
                                <h2><a href="tel:20024444">+966 2002 4444</a></h2>
                ...
                <div class="col-xl-8">
                    <div class="service-details__content">
                        <div class="service-details__content-img1">
                            <div class="inner">
                                <img src="{{ asset('assets/images/services/service-details-img8.jpg') }}" alt="#">
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="single-img">
                                        <img src="{{ asset('assets/images/services/service-details-img2.jpg') }}" alt="">
                                    </div>
                                </div>

                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="single-img">
                                        <img src="{{ asset('assets/images/services/service-details-img3.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="service-details__content-img3">
                            <img src="{{ asset('assets/images/services/service-details-img4.jpg') }}" alt="">
                        </div>
