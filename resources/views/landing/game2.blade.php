    ...
    <main>
        <section>
            ...
            <div class="restart-button-div">
                <button class="restart-button brown-button" id="restartButton" onClick="startGame()">Restart
                    ↻</button>
            </div>
        </section>
        ...
        <div class="modal" id="gameOverModal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="message">
                        <p>Congratulations! <span class="game-over-icons">🎊 🎊 🎊</span> You successfully completed
                            the game. <span class="game-over-icons" style="animation-delay: 0.2s">🎉 🎉 🎉</span></p>
    ...
    <footer>
        <div class="page-footer">
            <p>Made with
                ...
                <span aria-label="copyright">&COPY;</span> 2025.
            </p>
        </div>
    </footer>
    <script>
