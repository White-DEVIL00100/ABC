    ...
    <script>
        ...
        */
                ...
                while (tbEdges.length > 0) {
                    ...
                    do {
                        for (tries = 0; tries < 3; tries++) {
                            ...
                            edgeNumber = edgeIsInTbEdges(currEdge.kx + potNext.dkx, currEdge.ky + potNext.dky, potNext
                                .edge);
        ...
        class Puzzle {
            ...
            */
            ...
            computenxAndny() {
                ...
                let kx, ky, width = this.srcImage.naturalWidth,
        ...
        function loadInitialFile() {
            puzzle.srcImage.src = "https://abclogistic.com/assets/images/resources/faq-v1-img1.jpg";
        }
        //-----------------------------------------------------------------------------
            ...
            animate = function() {
                ...
                switch (state) {
                    ...
                    case 60: // winning
                        ...
                        tmpImage.style.left = (puzzle.polyPieces[0].x + puzzle.scalex / 2 + puzzle.gameWidth / 2) /
                            puzzle.contWidth * 100 + "%";
                        tmpImage.style.top = (puzzle.polyPieces[0].y + puzzle.scaley / 2 + puzzle.gameHeight / 2) /
                            puzzle.contHeight * 100 + "%";
